...
function checkExistAlgo(algorithmId, reqData) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (cnt === 0) {
            ...
            errorMSG_1.sendErrorMSG('Target algorithm ID가 아닙니다.' + JSON.stringify(reqData));
            return false;
        }
        return true;
    });
...
// fasle인 경우 DB 저장 X
function checkSameColumn(result, reqData) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (data.cnt >= 1) {
            ...
            errorMSG_1.sendErrorMSG('중복된 컬럼입니다.' + JSON.stringify(reqData));
            return false;
        }
        else {
            return true;
...
function checkLast2min(values, reqData) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (diffDays > rangeTime && lastFlag === 'on') {
            ...
            errorMSG_1.sendErrorMSG('2분이 지난 Signal Data가 들어왔습니다. req_data: ' + JSON.stringify(reqData));
            return false;
        }
        return true;
    });
...
// 텔레그램 메시지 발송 X
function checkTotalScore(values, mode, reqData) {
    return __awaiter(this, void 0, void 0, function* () {
        logger_1.default.info('total score가 5가 넘거나 0 아래로 떨어지는지 확인합니다.');
        const result = yield getTotalScore(values);
...
function checkSameTrading(values, reqData) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (data[0]['side'] === values['side']) {
            ...
            errorMSG_1.sendErrorMSG('동일 전략에 동일 매매 신호가 발생했습니다. req_data: ' + JSON.stringify(reqData));
            values['valid_type'] = -1;
            values['ord'] = -1;
        }
        return values;
