...
💚지금 등록시 첫 캐시 3,000P 바로 적립!`;
      ...
      "template": {
        ...
        toUserMsg =  `‍😎명품수선의 모든 것, 이젠 집 안에서!
#알아서다되는명품케어 #ㄹㅅㄹㅇㅇ
믿고 맡겨놔도, 전전긍긍 안절부절        
불안했던 명품 수선 과정 🥺
이젠 내 손, 내 눈으로 직접 확인하자!

🤷🏻‍♀️“결혼식에 들고 가려 수선 맡긴 명품백 날짜에 맞춰 올 수 있나요? 불안해서요”        
💚발품없이, 3분만에 무료 비교견적
💚걱정없이, 진행과정을 한눈에 확인
💚수거부터 배송까지, 버틀러 서비스

 🅾️20초 후에 나오는 퀴즈를 맞추면 1,000P 자동 적립됩니다.`;
        quizAnswer(userId);
        ctx.body = {
          "version": "2.0",
          "template": {
            "outputs": [
              {
                "basicCard": {
                  ...
                  "thumbnail": {
                    "imageUrl": "https://i.ibb.co/wSbDwsk/2023-01-27-11-13-04.png"
                  },
                  "buttons": [
                    {
                      "action": "webLink",
                      "label": "리뷰 보기",
                      "webLinkUrl": "https://www.instagram.com/p/CmqFRySrWDV/?utm_source=ig_web_copy_link"
                    },
                    {
                      "action": "webLink",
                      "label": "더 알아보기",
                      "webLinkUrl": "https://www.luxurynall.com/lna/index.html"
                    }
                  ]
                }
              }
