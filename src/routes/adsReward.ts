...
💚지금 등록시 첫 캐시 3,000P 바로 적립!`;
      ...
      "template": {
        ...
        toUserMsg =  `‍🧐바쁜 당신을 위해 비교해드릴게요
최저가 생활가전 렌탈 비교견적 필요할 땐
#ㄹㅌㄹ
        
✔️전국 실시간 가격 & 지원금 한 번에 비교
✔️리뷰 4,000건+ 검증된 판매자와 안심상담
✔️고객당 평균 31만원 절약
        
🤩지금 5분만에 전국 최저가 견적 받으세요`;
        quizAnswer(userId);
        ctx.body = {
          "version": "2.0",
          "template": {
            "outputs": [
              {
                "basicCard": {
                  ...
                  "thumbnail": {
                    "imageUrl": "https://i.ibb.co/gr9pLb2/004-7.png"
                  },
                  "buttons": [
                    {
                      "action": "webLink",
                      "label": "ㄹㅌㄹ 알아보기",
                      "webLinkUrl": "https://rentre.kr/main"
                    }
                  ]
                }
              }
