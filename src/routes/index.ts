...
추가) 더 많은 사람들이 공감할 수 있는 불편, 상황을 충분히 이해할 수 있는 설명, 어떻게 불편을 해결했는지 경험, 어떤 해결 방법을 원하는지 제안. 위 네가지 중 하나라도 더 자세하게 적어주시면 최대 2000원까지 포인트가 지급됩니다.추가) 더 많은 사람들이 공감할 수 있는 불편, 상황을 충분히 이해할 수 있는 설명, 어떻게 불편을 해결했는지 경험, 어떤 해결 방법을 원하는지 제안. 위 네가지 중 하나라도 더 자세하게 적어주시면 최대 2000원까지 포인트가 지급됩니다.`;
        resutlJson= {
          "version": "2.0",
          "template": {
              "outputs": [
