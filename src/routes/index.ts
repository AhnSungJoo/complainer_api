  ...
  if(fromUserMsg.trim().indexOf('불편제보') != -1) {
    ...
    try {
      ...
      if(existUser['cnt'] == 0 || existUserInfo['cnt'] != 0) {
        ...
        toUserMsg = `1. 많은 사람들이 공감할 수 있는 불편, 필요한 제품이나 서비스를 제보해주세요. \n
2. 제보 끝에 “접수” 라고 입력해주세요. 예시) “아플 때, 물어볼 의사가 없어서 불편해요. 접수” 혹은 “원격 진료가 있으면 좋겠어요. 밤에 애기가 갑자기 아프면 걱정돼요. 접수”\n
3. 더 많은 사람들이 공감할 수 있는 불편, 상황을 충분히 이해할 수 있는 설명, 어떻게 불편을 해결했는지 경험, 어떤 해결 방법을 원하는지 제안.\n
